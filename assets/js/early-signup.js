$(document).ready(function () {
  var $form = $('#early-signup-form');
  var $inputs = $('#early-signup-form :input');
  ...
  function signUp(event) {
    ...
    var url = r('uggcf://zl.fraqvaoyhr.pbz/hfref/fhofpevorrzorq/wf_vq/2ldcb/vq/2');
  ...
  function onReqSuccess(data) {
    ...
    if (res === 'success') {
      window.location = '/de/danke-vorab-anmeldung/';
      return;
    }
    if (res === 'emailExist')
